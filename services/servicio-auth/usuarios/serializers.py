...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    """
    JWT personalizado — incluye rol, departamento y datos del usuario.
    Así los demás servicios no necesitan consultar auth para saber quién es.
    """
    @classmethod
...
class RegistroCiudadanoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Usuario
        fields = ['email', 'username', 'first_name', 'last_name', 'rut', 'telefono', 'password', 'password2']
