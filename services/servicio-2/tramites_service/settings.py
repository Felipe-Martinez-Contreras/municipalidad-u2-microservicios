...
ROOT_URLCONF = 'tramites_service.urls'
...
WSGI_APPLICATION = 'tramites_service.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'tramites_service.authentication.JWTSinBDAuthentication',
    ),
...
# URL del servicio auth para verificaciones adicionales
